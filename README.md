...
## ✅ **كيف ترفع المشروع إلى GitHub**

1. **أنشئ مستودعًا جديدًا** على GitHub باسم `phishing-analysis-lab`.
2. **ارفع الملفات**:
   - `README.md`
   - `email3.eml` (إذا كان مسموحًا بنشره)
   - مجلد `screenshots/` (يحتوي على الصور)
   - `iocs.txt` (اختياري)
3. **اضغط Commit** ثم Push.

---

## 💡 **نصيحة إضافية**

- **إذا كنت لا تريد نشر البريد الأصلي** (لأسباب أخلاقية)، يمكنك فقط تضمين لقطات الشاشة التي تظهر المحتوى المشبوه دون الكشف عن بيانات حساسة.
- **أضف رابط المستودع** إلى ملفك الشخصي على LinkedIn وفي سيرتك الذاتية (CV).

---

**هل تريد مساعدة في إنشاء هذا المستودع أو رفع الملفات؟** 💪
